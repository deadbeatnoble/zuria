...
import com.ex.FG002.ProductBased.ProductDBHelper;
import com.ex.FG002.OpenSource.MyApplication;
import com.ex.FG002.OpenSource.NetworkChangeListener;
import com.ex.FG002.ProductBased.ProductAdapter;
import com.ex.FG002.ProductBased.ProductModel;
import com.ex.FG002.ProductBased.ProductUpload;
import com.ex.FG002.R;
import com.ex.FG002.OpenSource.UserDBHelper;
...
public class VendorBasedStoreFragment extends Fragment {
    ...
    public VendorBasedStoreFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_vendor_store, container, false);
    ...
    private List<ProductModel> generateProductModel() {
        ...
        productModels.addAll(new ProductDBHelper(this.getActivity()).getOwnerProduct(new MyApplication().getOwnerId()));
    ...
    private void uploadUnsyncedUserDataToFirebase() {
        ...
        for (Users unsyncedUser : unsyncedUsers) {
            ...
            updateUserData.put("storeImage", unsyncedUser.getStoreImage());
            updateUserData.put("storeName", unsyncedUser.getStoreName());
            updateUserData.put("storeLatitude", unsyncedUser.getStoreLatitude());
            updateUserData.put("storeLongitude", unsyncedUser.getStoreLongitude());
    ...
    private void offlineDeletedProducts() {
        List<ProductModel> deletedProducts = new ProductDBHelper(getActivity()).getDeletedProducts();
        for (ProductModel deletedProduct : deletedProducts) {
            ...
            public void onSuccess(Void unused) {
                fileReference.delete()
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                new ProductDBHelper(getActivity()).deleteProduct(productModel);
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                new ProductDBHelper(getActivity()).updateDeletedProducts(productModel.getProductId(), true);
    ...
    private void uploadUnsyncedProductsToFirebase() {
        ProductDBHelper productDbHelper = new ProductDBHelper(getActivity());
        List<ProductModel> unsyncedProducts = productDbHelper.getUnsyncedProducts();
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        uploadProduct(productModel, new UploadCallback() {
                            ...
                            public void onSuccess(boolean success) {
                                productDbHelper.updateProductSyncStatus(productModel.getProductId(), success);
                            }
                        });
                        /*if (uploadProduct(productModel)) {
                            productDbHelper.updateProductSyncStatus(productModel.getProductId(), true);
                        } else {
                            productDbHelper.updateProductSyncStatus(productModel.getProductId(), false);
                        }*/
                    }
                }
        ...
        productRef.updateChildren(updateData)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        new ProductDBHelper(getActivity()).updateProductSyncStatus(productModel.getProductId(), true);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        new ProductDBHelper(getActivity()).updateProductSyncStatus(productModel.getProductId(), false);

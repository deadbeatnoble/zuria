    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.s_productStatus.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (compoundButton.isPressed()) {
                    ...
                    editor.apply();
                    if (new ProductDBHelper(context).updateSwitchState(productList.get(position).getProductId(), isChecked)) {
                            ...
                            databaseReference.updateChildren(updatedData)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            new ProductDBHelper(context).updateProductSyncStatus(productList.get(position).getProductId(), true);
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            new ProductDBHelper(context).updateProductSyncStatus(productList.get(position).getProductId(), false);
                                        }
                                    });
                        } else {
                            new ProductDBHelper(context).updateProductSyncStatus(productList.get(position).getProductId(), false);
        ...
        holder.acb_removeProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (NetworkChangeListener.syncStatus) {
                    //connected
                    //productDbHelper.deleteProduct(productModel);
                    ...
                    productDbHelper.updateDeletedProducts(productModel.getProductId(), true);
                    productList.remove(position);
                    notifyDataSetChanged();

                    /*List<ProductModel> deletedProducts = productDbHelper.getDeletedProducts();
            ...
            public void onSuccess(Void unused) {
                fileReference.delete()
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                new ProductDBHelper(context).deleteProduct(productModel);
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                new ProductDBHelper(context).updateDeletedProducts(productModel.getProductId(), true);

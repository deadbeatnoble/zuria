...
public class CreateProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cancelProduct = findViewById(R.id.btn_cancelProduct);

        productDbHelper = new ProductDBHelper(CreateProduct.this);
        ...
        btn_addProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(til_productName.getEditText().getText().toString().isEmpty() || til_productPrice.getEditText().getText().toString().isEmpty() || til_productDescription.getEditText().getText().toString().isEmpty() || iv_productImage.getDrawable() == null) {
                    ...
                    Boolean success = productDbHelper.addProduct(productModel);
                    ...
                    if (success) {
                        if (NetworkChangeListener.syncStatus == true) {
                            ...
                            productDbHelper.updateProductSyncStatus(productId,false);
                        }
                    ...
                    startActivity(new Intent(CreateProduct.this, VendorPOV.class));
                }
            }
        });
        btn_cancelProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CreateProduct.this, VendorPOV.class);

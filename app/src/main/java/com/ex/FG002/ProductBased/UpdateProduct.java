...
public class UpdateProduct extends AppCompatActivity {
    ...
    private Button btn_discardProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductModel productModel = productDbHelper.getProductById(productId);
        ...
        if (productModel != null) {
            ...
            imageUri = Uri.parse(productModel.getProductImage());
            //assign the former image uri path to the imageUri variable
        ...
        btn_updateProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(UpdateProduct.this, VendorPOV.class));
            }
        });
        btn_discardProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpdateProduct.this, VendorPOV.class);
    ...
    public void update(View view, boolean constantProductStatus) {
        ...
        //replaced it with the global variable imageUri and tried commenting it out to avoid calling it
        //String productImage = String.valueOf(getUriFromDrawable(iv_productImageUP.getDrawable()));

        ProductModel productModel = new ProductModel(productId, productName, Double.parseDouble(productPrice), productDescription, imageUri.toString(), new MyApplication().getOwnerId(), NetworkChangeListener.syncStatus, constantProductStatus, false);
        ...
        if (NetworkChangeListener.syncStatus) {
            ...
            //not connected
            productDbHelper.updateProduct(productModel);
            productDbHelper.updateProductSyncStatus(productModel.getProductId(), false);
        }

        Boolean success = productDbHelper.updateProduct(productModel);
                                ...
                                databaseReference.child(productModel.getProductId())
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                new ProductDBHelper(UpdateProduct.this).updateProduct(productModel);
                                                new ProductDBHelper(UpdateProduct.this).updateProductSyncStatus(productModel.getProductId(), true);
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                new ProductDBHelper(UpdateProduct.this).updateProduct(productModel);
                                                new ProductDBHelper(UpdateProduct.this).updateProductSyncStatus(productModel.getProductId(), false);
